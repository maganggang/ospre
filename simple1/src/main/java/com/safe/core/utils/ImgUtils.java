...
public class ImgUtils {
	    ...
	    public static void main(String[] args) {
	        // 1-缩放图像：
	        // 方法一：按比例缩放
	        scale("d:/aa.jpg", "d:/aa1.jpg", 2, true);//测试OK
	        // 方法二：按高度和宽度缩放
	       scale2("d:/aa.jpg", "d:/aa2.jpg", 500, 300, true);//测试OK


	        // 2-切割图像：
	        // 方法一：按指定起点坐标和宽高切割
	        cut("d:/aa.jpg", "d:/aa3.jpg", 0, 0, 400, 400 );//测试OK
	        // 方法二：指定切片的行数和列数
	      cut2("d:/aa.jpg", "d:/", 2, 2 );//测试OK
	        // 方法三：指定切片的宽度和高度
	        cut3("d:/aa.jpg", "d:/", 300, 300 );//测试OK


	        // 3-图像类型转换：
	       convert("d:/aa.jpg", "GIF", "d:/abc_convert.gif");//测试OK


	        // 4-彩色转黑白：
	      gray("d:/aa.jpg", "d:/abc_gray.jpg");//测试OK


	        // 5-给图片添加文字水印：
	        // 方法一：
	      pressText("我是水印文字","d:/aa.jpg","d:/abc_pressText.jpg","宋体",Font.BOLD,Color.white,80, 0, 0, 0.5f);//测试OK
	        // 方法二：
	     pressText2("我也是水印文字", "d:/aa.jpg","d:/abc_pressText2.jpg", "黑体", 36, Color.white, 80, 0, 0, 0.5f);//测试OK
	        
	        // 6-给图片添加图片水印：
	        pressImage("d:/aa.jpg", "d:/ab.jpg","d:/abc_pressImage.jpg", 0, 0, 0.5f);//测试OK
	    }
